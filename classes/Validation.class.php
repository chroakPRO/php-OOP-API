...
{    
    ...
    public $regexpatterns = array(
        ...
        'github-user' => '[A-Za-z0-9-]',
        'github-title' => '[A-Za-z0-9\-\_]',
        'feedback-text'=> '[a-zA-Z0-9åäö_,;.()\-\/ ]',
   ...
   public function value($value)
    {
        ...
        array_push($this->dirtyStrings, $this->value);
        return $this;
    } 
